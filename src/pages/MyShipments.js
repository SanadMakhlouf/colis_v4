            ...
            {filteredShipments.map(shipment => (
              ...
              >
                ...
                <div className="shipment-details">
                  ...
                  <p><strong>Destinataire:</strong> {shipment.receiver_name}</p>
              ...
              <div className="shipment-details">
                ...
                <div className="shipment-info">
                  ...
                  <div className="detail-item">
                    ...
                    <div className="detail-value">{selectedShipment.receiver_name}</div>
                  </div>

                  <div className="detail-item">
                    <div className="detail-label">Téléphone</div>
                    <div className="detail-value">{selectedShipment.receiver_phone}</div>
                  </div>

                  <div className="detail-item">
                    <div className="detail-label">Email</div>
                    <div className="detail-value">{selectedShipment.receiver_email}</div>
                  </div>

                  <div className="detail-item">
                    <div className="detail-label">Adresse</div>
                    <div className="detail-value">{selectedShipment.receiver_address}</div>
                  </div>
